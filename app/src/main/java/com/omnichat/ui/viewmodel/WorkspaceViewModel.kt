...
import com.omnichat.service.WorkspaceForegroundService
import com.omnichat.workspace.*
import com.omnichat.workspace.TeamCompletionSnapshot
...
class WorkspaceViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val _teamTasks = MutableStateFlow<List<com.omnichat.data.TeamTask>>(emptyList())
    val teamTasks: StateFlow<List<com.omnichat.data.TeamTask>> = _teamTasks.asStateFlow()
     ...
     * 获取可恢复的活跃工作区团队列表。
     */
    suspend fun getResumableTeams(): List<com.omnichat.data.WorkspaceTeam> {
    ...
    fun submitTask(task: String, orchestratorModelConfigId: Long, orchestratorOverrideModelId: String? = null, imagePath: String? = null, sandboxPath: String? = null) {
        ...
        viewModelScope.launch {
            try {
                ...
                teamManager = null
                com.omnichat.mcp.BuiltinToolHandler.teamManager = null
                WorkspaceForegroundService.stop(getApplication())
    ...
    private fun createTeamManager(wsId: Long): TeamManager {
        ...
        managerRef = manager
        com.omnichat.mcp.BuiltinToolHandler.teamManager = manager
        return manager
    }
